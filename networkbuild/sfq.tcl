...
set mytrace [open l7p2.tr w] 
$ns trace-all $mytrace 
 
set mynAM [open l7p2.nam w] 
...
$ns duplex-link $n3 $n1 1Mb 10ms SFQ 
$ns duplex-link-op $n3 $n1 orient left 
 
$ns duplex-link $n3 $n0 1Mb 10ms SFQ 
...
$ns duplex-link $n4 $n6 1Mb 10ms SFQ 
$ns duplex-link-op $n4 $n6 orient right 
 
$ns duplex-link $n4 $n7 1Mb 10ms SFQ 
